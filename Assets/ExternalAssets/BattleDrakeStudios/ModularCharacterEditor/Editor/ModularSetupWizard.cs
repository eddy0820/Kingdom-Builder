...
namespace BattleDrakeStudios.ModularCharacters {
    public class ModularSetupWizard : EditorWindow {
        ...
        private void CommitChanges(bool openEditor) {
            if (isNewMaterial) {
                if(!AssetDatabase.IsValidFolder("Assets/ExternalAssets/BattleDrakeStudios/ModularCharacterEditor/Materials")) {
                    AssetDatabase.CreateFolder("Assets/ExternalAssets/BattleDrakeStudios/ModularCharacterEditor", "Materials");
                }
                AssetDatabase.CreateAsset(characterMat, "Assets/ExternalAssets/BattleDrakeStudios/ModularCharacterEditor/Materials/" + materialName + ".mat");
            }
