...
public class GridXZ<TGridObject> {
    ...
    public GridXZ(int width, int height, float cellSize, Vector3 originPosition, Func<GridXZ<TGridObject>, int, int, TGridObject> createGridObject, bool debug,int debugFontSize) {
        this.width = width;
        this.height = height;
